...
import {App, VsDocsContentProvider, VsCompletionItemProvider } from './app';
...
export function activate(context: vscode.ExtensionContext) {
	...
	console.log('Congratulations, your extension "vuesax-helper" is now active!');
    let app = new App();
    app.setConfig();
	let docs = new VsDocsContentProvider();
	let completionItemProvider = new VsCompletionItemProvider();
	let registration = vscode.workspace.registerTextDocumentContentProvider('vuesax-helper', docs);
	...
	let disposable = vscode.commands.registerCommand('vuesax-helper.search', () => {
        // if (context.workspaceState.get('vuesax-helper.loading', false)) {
